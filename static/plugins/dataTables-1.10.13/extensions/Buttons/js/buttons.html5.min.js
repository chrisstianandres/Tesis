            ...
            className: "buttons-copy buttons-html5", text: function (a) {
                ...
                if (k.queryCommandSupported("copy")) {
                    ...
                    try {
                        ...
                        d.remove();
                        if (f) {
                            c.buttons.info(c.i18n("buttons.copyTitle", "Copy to clipboard"),
        ...
        className: "buttons-excel buttons-html5", available: function () {
            ...
            var e = 0, a = function (a) {
                ...
                for (var b = 0, c = a.length; b < c; b++) {
                    for (var d =
                        b, g = ""; 0 <= d;) g = String.fromCharCode(d % 26 + 65) + g, d = Math.floor(d / 26) - 1;
                    var d = g + "" + m, j = null;
    ...
    l.ext.buttons.pdfHtml5 = {
        ...
        action: function (a, c, d, b) {
            ...
            b.message && a.content.unshift({
                text: "function" == typeof b.message ? b.message(c,
                    d, b) : b.message, style: "message", margin: [0, 0, 0, 12]
            });
