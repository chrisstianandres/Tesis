    ...
    var _exportData = function (dt, config) {
        ...
        if (config.header) {
            ...
            for (var i = 0, ien = data.header.length; i < ien; i++) {
                ...
                rawHeader.forEach(function (item, i) {
                    if (item == "_colspan_" || item == "_rowspan_") rawHeader[i] = '';
                });
        ...
        if (config.footer && data.footer) {
            ...
            for (var i = 0, ien = data.footer.length; i < ien; i++) {
                ...
                rawFooter.forEach(function (item, i) {
                    if (item == "_colspan_" || item == "_rowspan_") rawFooter[i] = '';
                });
